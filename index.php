        ...
        <div class="row text-center">
            ...
            <div id="myCarousel" class="carousel text-center" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item">
                        <h4>Q: How much do classes cost?<br><br><span>A: The classes we each every Wednesday at Willard Straight are completely free. Occassionally, we will invite a famous lindy hopper to Cornell to hold workshops, and these will not be free. Check the events page to see when these workshops are!</span></h4>
                    </div>
                    <div class="item">
